namespace Abgabe_5 {
    ...
    if (path == "index.html" || path == "") {
        ...
        let btEditTop: HTMLImageElement = <HTMLImageElement>document.getElementById("btTop");
        btEditTop.addEventListener("click", openDetailTop);
        let btEditMiddle: HTMLImageElement = <HTMLImageElement>document.getElementById("btMiddle");
        btEditMiddle.addEventListener("click", openDetailMiddle);
        let btEditBottom: HTMLImageElement = <HTMLImageElement>document.getElementById("btBottom");
        ...
        async function sendCacheToServer(_url: string): Promise<void> {
            ...
            let text: ServerA = await resp.json();
        ...
        function showServerAnswer(_answer: ServerA): void {
            let statusField: HTMLParagraphElement = <HTMLParagraphElement>document.getElementById("sOutput");
